...
gn gen out/Release --args='target_cpu="x86" is_debug=false mac_sdk_min="10.12" angle_enable_metal=false angle_enable_swiftshader=false angle_enable_vulkan=false'
